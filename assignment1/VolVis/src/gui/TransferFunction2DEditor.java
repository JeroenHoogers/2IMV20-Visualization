...
public class TransferFunction2DEditor extends javax.swing.JPanel {
    ...
    public TransferFunction2DEditor(Volume volume, GradientVolume gradientvolume) {
        ...
        triangleWidget = new TriangleWidget((short) (maxIntensity / 2), 0.2, 0.2, 0.8);
        setSelectedInfo();
    }
    ...
    public class TriangleWidget 
    {
        ...
        public double minGradMagnitude;
        public double maxGradMagnitude;

        public TriangleWidget(short base, double r, double minGradMag, double maxGradMag) {
            this.baseIntensity = base;
            this.radius = r;
            this.color = new TFColor(0.0, 204.0/255.0, 153.0/255.0, 0.3);
            this.minGradMagnitude = minGradMag;
            this.maxGradMagnitude = maxGradMag;
        }
    }
